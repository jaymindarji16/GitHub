...
public class Questions extends AppCompatActivity {
    DonutProgress donutProgress, donutQueProgress;
    int variable =0;
    TextView ques;
    ...
    public int c1 = 0, c2 = 0, c3 = 0, c4 = 0, c5 = 0, c6 = 0, c7 = 0, c8 = 0, c9 = 0, c10 = 0, i = 0;
    // j Question Counter
    public int j = 0, k = 0, l = 0;
    public static final long vibratorDelay = 300;
    // gloabal - Answer
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        donutQueProgress = (DonutProgress) findViewById(R.id.donutQueProgress);
        donutQueProgress.setMax(10);
        donutQueProgress.setFinishedStrokeColor(Color.parseColor("#FFFB385F"));
        donutQueProgress.setTextColor(Color.parseColor("#FFFB385F"));
        donutQueProgress.setKeepScreenOn(true);
        //donutQueProgress.setPrefixText("Q: ");
    ...
    public void onClick(View v) {
        ...
        MediaPlayer ring= MediaPlayer.create(Questions.this,R.raw.beep);
        SharedPreferences sp = getSharedPreferences("Score", Context.MODE_PRIVATE);
        ...
        if (visibility == 0) {
            ...
            donutQueProgress.setVisibility(View.VISIBLE);
            ...
            new CountDownTimer(50000, 1000) {//countdowntimer
                ...
                public void onTick(long millisUntilFinished) {
                    ...
                    //------- If 10 Question is completed we finish quiz or timing is over whatever is earlear----------
                    if(j == 10)
                    {
                        toast.cancel();
                        ...
                        donutQueProgress.setProgress(0);
                        if(variable==0) {
        ...
        if (global != null) {
            ...
            if (global.equals("A")) {
                ...
                if (v.getId() == R.id.OptionA) {
                    ...
                    vibrator.vibrate(vibratorDelay);
                    //OptA.setBackgroundColor(Color.RED);
                }
        ...
        //----------
        // j is question counter
        if(j == 1)
        {
            donutQueProgress.setProgress((j));
            ques.setText("" + Ques);
            OptA.setText(Opta);
            OptB.setText(Optb);
            OptC.setText(Optc);
            ...
            OptA.setBackgroundColor(getResources().getColor(R.color.colorButtonNormal));
            OptB.setBackgroundColor(getResources().getColor(R.color.colorButtonNormal));
            OptC.setBackgroundColor(getResources().getColor(R.color.colorButtonNormal));
            OptD.setBackgroundColor(getResources().getColor(R.color.colorButtonNormal));
        }
        else {
            donutQueProgress.setProgress((j));
